...
#define RK_FILE_FORMAT _T("FileFormat")
#define RK_ANIMATION _T("Animation")
#define RK_AUTO_ROTATE _T("AutoRotate")
	...
	, m_bAutoRotate(FALSE)
{
	...
	m_iFileFormat = theApp.GetProfileInt(RK_RECORD, RK_FILE_FORMAT, FF_BMP);
	m_bAutoRotate = theApp.GetProfileInt(RK_RECORD, RK_AUTO_ROTATE, TRUE);
	m_bAnimation = theApp.GetProfileInt(RK_RECORD, RK_ANIMATION, TRUE);
	m_fFrameRate = 30;
	m_iFrameSize = 0;
...
void CRecordDlg::FrameToTime(int Frame, double FrameRate, CString& Time)
{
	if (FrameRate > 0) {
...
void CRecordDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_CBIndex(pDX, IDC_RECORD_FILE_FORMAT, m_iFileFormat);
	DDX_Check(pDX, IDC_RECORD_ANIMATION, m_bAnimation);
	DDX_Check(pDX, IDC_RECORD_AUTO_ROTATE, m_bAutoRotate);
}
...
void CRecordDlg::OnOK()
{
	...
	theApp.WriteProfileInt(RK_RECORD, RK_FILE_FORMAT, m_iFileFormat);
	theApp.WriteProfileInt(RK_RECORD, RK_AUTO_ROTATE, m_bAutoRotate);
	theApp.WriteProfileInt(RK_RECORD, RK_ANIMATION, m_bAnimation);
}
